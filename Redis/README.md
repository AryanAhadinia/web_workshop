...
<img src="https://github.com/AryanAhadinia/web_workshop/blob/redis/Redis/public/ubuntu/ubuntu_1.png" alt="ubuntu_1">
...
<img src="https://github.com/AryanAhadinia/web_workshop/blob/redis/Redis/public/ubuntu/ubuntu_2.png" alt="ubuntu_2">
...
8. این یک قابلیت امنیتی برای تغییر نام دستورات خطرناک است. در صورتی که تمایلی به انجام آن ندارید، می توانید این بخش را دنبال نکنید.
   یک قابلیت امنیتی دیگر که ردیس فراهم می آورد. تغییر نام یا غیر فعال کردن دستوراتی است که اجرای آنها میتواند خطرناک باشد.
   اجرای این دستورات میتواند اتفاقی یا باشد یا توسط بدخواهان خارجی اتفاق بیفتد.
...
دستورات لیست زیر از جمله دستورات خطرناک هستند. هر چند که این لیست، جامع نیست.
...
لیست کامل دستورات ردیس را میتوانید از لینک روبرو دریافت کنید.
[http://redis.io/commands](http://redis.io/commands)

فراخور نیاز هر پروژه، میتوانید نام دستورات خطرناک را به یک نام دلخواه تغییر دهید یا به صورت کلی اجرای آن دستور را غیر فعال کنید.
...
<img src="https://github.com/AryanAhadinia/web_workshop/blob/redis/Redis/public/ubuntu/ubuntu_3.png" alt="ubuntu_3">
...
با استفاده از این دستور، عنصر سر راست لیست حذف و برگردانده میشود.
...
با استفاده از این دستور، عنصر سر چپ لیست حذف و برگردانده میشود.
